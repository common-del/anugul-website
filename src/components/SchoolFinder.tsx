...
export default function SchoolFinder({
  ...
  return (
    ...
    <div className={`md:grid md:grid-cols-2 md:gap-5 ${tip ? "md:items-stretch" : "md:items-start"}`}>
      ...
      <div className={`glass-strong p-4 ${tip ? "md:flex md:flex-col" : ""}`}>
        ...
        {tip && (
          <div className="mt-3 flex items-center gap-3 rounded-xl bg-gov-tint p-3.5 md:flex-1">
            ...
            <svg width="64" height="56" viewBox="0 0 64 56" fill="none" aria-hidden className="hidden shrink-0 sm:block">
              ...
              <text x="19" y="16" textAnchor="middle" fontSize="6.5" fontWeight="700" fill="#2D3A47">A+</text>
              <line x1="27" y1="11" x2="39" y2="11" stroke="#2D3A47" strokeWidth="2" strokeLinecap="round" />
              <line x1="27" y1="16" x2="36" y2="16" stroke="#E9ECEE" strokeWidth="2" strokeLinecap="round" />
              <line x1="15" y1="24" x2="39" y2="24" stroke="#E9ECEE" strokeWidth="2" strokeLinecap="round" />
              <line x1="15" y1="29" x2="35" y2="29" stroke="#2D3A47" strokeWidth="2" strokeLinecap="round" />
      ...
      <div className="mt-4 glass-strong p-4 md:mt-0">
        {!block && (
          <>
