...
export default function WhatsAppShare({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex min-h-[54px] items-center justify-center gap-2.5 rounded-xl bg-[#1F8A5B] px-6 text-[16px] font-extrabold text-white shadow-sm active:brightness-110"
    >
