...
export default function WhatsAppShare({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex min-h-[54px] items-center justify-center gap-2.5 rounded-xl bg-[#128C7E] px-6 text-sm font-extrabold text-white shadow-sm active:brightness-110"
    >
