  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-xl ${
        variant === "outline"
          ? "min-h-[44px] gap-2 border-2 border-[#128C7E] bg-white px-4 text-sm font-bold text-[#128C7E] active:brightness-95"
          : "min-h-[54px] gap-2.5 bg-[#128C7E] px-6 text-sm font-extrabold text-white shadow-sm active:brightness-110"
      }`}
    >
